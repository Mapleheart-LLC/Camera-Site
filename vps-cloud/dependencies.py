...
ALGORITHM: str = "HS256"
# Override via JWT_ACCESS_TOKEN_EXPIRE_MINUTES env var (default: 480 minutes).
...
try:
    ...
    _logging.getLogger(__name__).warning(
        "JWT_ACCESS_TOKEN_EXPIRE_MINUTES is not a valid integer; falling back to 480 minutes."
    )
