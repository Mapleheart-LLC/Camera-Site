...
def get_admin_user(
    ...
    """
    Verify HTTP Basic Auth credentials against ADMIN_USERNAME / ADMIN_PASSWORD.

    Uses ``secrets.compare_digest`` for both comparisons to prevent timing
    attacks that could reveal valid usernames or passwords.
